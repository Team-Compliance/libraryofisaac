local PHD_PILL_CONVERSIONS = {
    ...
    [PillEffect.PILLEFFECT_AMNESIA] = PillEffect.PILLEFFECT_I_CAN_SEE_FOREVER,
    [PillEffect.PILLEFFECT_R_U_A_WIZARD] = PillEffect.PILLEFFECT_POWER,
    [PillEffect.PILLEFFECT_ADDICTED] = PillEffect.PILLEFFECT_PERCS,
    [PillEffect.PILLEFFECT_QUESTION_MARKS] = PillEffect.PILLEFFECT_TELEPILLS,
    [PillEffect.PILLEFFECT_RETRO_VISION] = PillEffect.PILLEFFECT_I_CAN_SEE_FOREVER,
...
local FALSE_PHD_PILL_CONVERSIONS = {
    ...
    [PillEffect.PILLEFFECT_TELEPILLS] = PillEffect.PILLEFFECT_QUESTION_MARKS,
    [PillEffect.PILLEFFECT_FORTY_EIGHT_HOUR_ENERGY] = PillEffect.PILLEFFECT_SPEED_DOWN,
    [PillEffect.PILLEFFECT_HEMATEMESIS] = PillEffect.PILLEFFECT_BAD_TRIP,
    [PillEffect.PILLEFFECT_I_CAN_SEE_FOREVER] = PillEffect.PILLEFFECT_AMNESIA,
    ...
    [PillEffect.PILLEFFECT_ONE_MAKES_YOU_LARGER] = PillEffect.PILLEFFECT_RANGE_DOWN,
    [PillEffect.PILLEFFECT_ONE_MAKES_YOU_SMALL] = PillEffect.PILLEFFECT_SPEED_DOWN,
    ...
    [PillEffect.PILLEFFECT_POWER] = PillEffect.PILLEFFECT_R_U_A_WIZARD,
    ...
    [PillEffect.PILLEFFECT_FEELS_LIKE_IM_WALKING_ON_SUNSHINE] = PillEffect.PILLEFFECT_RETRO_VISION,
